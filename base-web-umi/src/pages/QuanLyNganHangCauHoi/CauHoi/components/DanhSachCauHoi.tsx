...
const DanhSachCauHoi = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            dataIndex: 'monHocId',
            key: 'monHocId',
            render: (val: any) => typeof val === 'object' ? val?.tenMonHoc : listMonHoc.find(m => m._id === val)?.tenMonHoc || val
        },
        {
            title: 'Khối Kiến Thức',
            dataIndex: 'khoiKienThucId',
            key: 'khoiKienThucId',
            render: (val: any) => typeof val === 'object' ? val?.tenKhoiKienThuc : listKhoiKienThuc.find(k => k._id === val)?.tenKhoiKienThuc || val
        },
        {
            title: 'Mức Độ Khó',
            dataIndex: 'mucDoKho',
